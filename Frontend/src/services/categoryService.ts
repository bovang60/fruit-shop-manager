...
export async function getCategories(
...
): Promise<ApiResponse<PageResponse<CategoryDto>>> {
  const params = new URLSearchParams();
  if (filter.search) params.append("search", filter.search);
  if (filter.status) params.append("status", filter.status);
  if (filter.sortByProductCount !== undefined)
    params.append("sortByProductCount", filter.sortByProductCount.toString());
  ...
  try {
    return await callApi<undefined, ApiResponse<PageResponse<CategoryDto>>>(
      url,
    );
  } catch (error) {
...
export async function getCategoryById(
  ...
  try {
    return await callApi<undefined, ApiResponse<CategoryDto>>(
      `/api/categories/${id}`,
    );
  } catch (error) {
    ...
    return {
      resultCd: 1,
      message: "Lỗi kết nối khi lấy thông tin danh mục",
      data: null,
    };
  }
}
...
export async function createCategory(
  ...
  try {
    return await callApiWithMethod<CreateCategoryDto, ApiResponse<CategoryDto>>(
      "POST",
      "/api/categories",
      data,
    );
...
export async function deleteCategory(
  ...
  try {
    return await callApiWithMethod<undefined, ApiResponse<CategoryDto | null>>(
      "DELETE",
      `/api/categories/${id}`,
    );
  } catch (error) {
...
export async function toggleCategoryStatus(
  ...
  try {
    return await callApiWithMethod<undefined, ApiResponse<CategoryDto>>(
      "PUT",
